 ...
 * @description :
 */
public class ShopHourBO extends PageInfo {
    ...
    private String createTime= Times.now();
    ...
    private List<ShopHourBO> shopHourBOList;
    ...
    public List<ShopHourBO> getShopHourBOList() {
        return shopHourBOList;
    }

    public void setShopHourBOList(List<ShopHourBO> shopHourBOList) {
        this.shopHourBOList = shopHourBOList;
    }

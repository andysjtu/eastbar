...
<form id="sform">
    ...
    <div class="search mt1 mlr2">
        <table width="100%" cellspacing="0" cellpadding="0">
            ...
            <tr onclick="$('.searchContext').toggle();" class="panel-header">
                <!--title -->
                <td class="panel-title">程序使用查询</td>
                <!--后留白 -->
                <td>&nbsp;</td>
            </tr>
            </thead>
                ...
                <td>
                    <div class="mlr8">
                        <p><span class="ipm">场所编码<input type="text" name="siteCode"/></span>
                            <span class="ipm">程序名称<input type="text" name="programName"/></span></p>
                        <p class="dp pt5"><span class="ipm">时间<input name="btime"  type="text" class="easyui-datetimebox" value="${progHistoryBO.btime}"/></span>
                            <span class="ipm">&nbsp;&nbsp;至&nbsp;<input name="etime" type="text" class="easyui-datetimebox" value="${progHistoryBO.etime}"/></span></p>
                    </div>
    ...
    <div class="result mlr2 mt5">
        <div>
            <table id="rtt" class="easyui-datagrid" title="程序使用记录列表" style="width:100%;height:auto"
                   data-options="rownumbers:true,
				singleSelect:false,
				autoRowHeight:false,
				pagination:true,
				striped:true,
				pageSize:10,url:'${ctx}/unit/programjson',method:'post',queryParams:$.formParams('#sform')">
            <thead>
            <tr>
                ...
                <th data-options="field:'hostIp',align:'center'" width="6%">客户机地址</th>
                ...
                <th data-options="field:'customerIdType',align:'center',formatter:replaceCert" width="6%">顾客类型</th>
                <th data-options="field:'isBlock',align:'center',formatter:replaceBlock" width="6%">是否拦截</th>
            </tr>
            </thead>
        </table>
    </div>

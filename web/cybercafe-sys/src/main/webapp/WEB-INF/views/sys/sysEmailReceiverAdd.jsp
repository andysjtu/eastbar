...
<html>
   <head>
        <title>添加SMTP服务器设置</title>
        <!--  <link href="${ctx}/static/styles/sys.css" type="text/css" rel="stylesheet"/>-->
    </head>
    <body>
    <div class="result">
        <div>
            <form id="f1" action="${ctx}/sys/submitEmailReceiverAdd#_3" method="post" class="form-horizontal">
                <div class="mlr8" style="border: 1px solid #d4d4d4;">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="receiver" id="receiver" placeholder="电子邮件">
                        </div>
                    </div>

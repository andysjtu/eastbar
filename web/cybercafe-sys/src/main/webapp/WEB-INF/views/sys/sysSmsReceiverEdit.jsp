...
<html>
<head>
    <title>修改短消息接收者</title>
    <!--  <link href="${ctx}/static/styles/sys.css" type="text/css" rel="stylesheet"/>-->
</head>
<body>
<div class="result">
    <div>
        <form id="f1" action="${ctx}/sys/submitSmsReceiverEdit" method="post" class="form-horizontal">
            <div class="mlr8" style="border: 1px solid #d4d4d4;">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="receiver" id="receiver" value="${alarmNotify.receiver}" placeholder="手机号码">
                    </div>
                </div>

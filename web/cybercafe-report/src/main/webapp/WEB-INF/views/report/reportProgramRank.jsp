...
<div class="result">
    <div>
        <form id="f1" action="${ctx}/report/programRankSearch#_6" method="post" class="form-horizontal">
            <div class="mlr8" style="border: 1px solid #d4d4d4;">
                <hr/><blockquote> <small>应用程序使用状况排行榜条件输入</small></blockquote>
                ...
                <div class="control-group">
                    <label class="control-label">场所范围：</label>
                    <div class="controls">
                        <input type="radio" name="objectType" value="d" checked="checked">所有
                        &nbsp;&nbsp;&nbsp;<span>对当前系统所有场所的顾客URL访问记录进行排行</span>
                    </div><br/>
                    <div class="controls">
                    ...
                    <%--<div class="controls">--%>
                    <%--<input type="radio" name="objectType" value="b">按编码--%>
                    <%--&nbsp;&nbsp;&nbsp;<input type="text"/>--%>
                    <%--</div><br/>--%>
                </div>
                <hr style="margin: 20px 10px;"/>

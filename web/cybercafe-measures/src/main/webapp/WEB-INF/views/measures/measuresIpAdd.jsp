...
<div class="result">
   <div>
        <form id="f1" action="${ctx}/measures/submitIpAdd" method="post" class="form-horizontal">
            <div class="mlr8" style="border: 1px solid #d4d4d4;">
              ...
              <div class="control-group">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text"  name="urlValues" id="urlValue">*必填项
                    </div>
                </div>
                <div class="control-group">
...
<script>
    ...
    function add(){
        var html="<div><hr/><blockquote><small>禁止Ip信息<a href='javascript:void(0)' onclick='closeAdd(this)' name='close' style='margin-left: 40px;color: #0000ff'>[关闭]</a></small></blockquote><div class='control-group'><label class='control-label'>URL类型</label><div class='controls'><select name='urlTypes' id='urlType'><option value='2'>IP地址</option></select></div></div><div class='control-group'><label class='control-label'>IP</label><div class='controls'><input type='text'  name='urlValues' id='urlValue'>*必填项</div></div><div class='control-group'><label class='control-label' >告警类型</label><div class='controls'><select name='alarmTypes'><option value='2'>运行报警</option></select></div></div><div class='control-group'><label class='control-label' >报警等级</label><div class='controls'><select name='alarmRanks'><option value='1'>严重报警</option><option value='2'>中等程度报警</option><option value='3'>一般报警</option></select></div></div><div class='control-group'><label class='control-label' >是否拦截</label><div class='controls'><select name='isBlocks'><option value='1'>是</option><option value='0'>否</option></select></div></div></div>";
        $("#add").append($(html));
    }

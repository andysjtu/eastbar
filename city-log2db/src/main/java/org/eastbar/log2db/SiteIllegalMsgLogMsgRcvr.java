 ...
 */
public class SiteIllegalMsgLogMsgRcvr implements MessageListener {

    public final static Logger logger = LoggerFactory.getLogger(SiteIllegalMsgLogMsgRcvr.class);
...
//            }, content.getBytes(Charsets.UTF_8));
            ...
            logger.warn("处理IllegalJMS异常出错:", e);
        } catch (Throwable t) {
            logger.warn("处理入库程序出错：", t);
        }
    }

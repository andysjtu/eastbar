...
//    private static int SC_NO_AVAILABLE_SERVER = 500; // 请求服务端可能不存在
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        try {
            ...
            logger.debug("receive Biz type is {}", len1001);
...
//            logger.info("content is : " + value);
    ...
    private void processLogout(String value) throws IOException {
    ...
    private void processLogin(String value) throws IOException {
    ...
    private void processConnect(ChannelHandlerContext ctx, String value) {
    ...
    public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause)
            throws Exception {
        logger.warn("Unexpected exception from OUTER.........", cause.getMessage());
        ctx.close();
    }
